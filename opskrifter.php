...
<div class="container">
    ...
    <div class="container">
        ...
        <div class="toggle-buttons">
            <a href="opskrifter.php"> <button class="btn btn-outline-primary active" style="border-radius: 50px 0px 00px 50px">Opskrifter</button></a>

            <a href="favorit.php"> <button class="btn btn-outline-primary " style="border-radius: 00px 50px 50px 00px">Favoritter</button></a>
        </div>
    </div>
    ...
    <div class="container mt-5">
        ...
        <div class="custom-card mt-1">
            <div class="favorite-star not-favorite">
                ★
            </div>
            <!-- Billede -->
        ...
        <div class="custom-card mt-1">
            ...
            <!-- Billede -->
            <img src="pictures/lassagne.png" alt="Lasagne">

            <!-- Tekstindhold -->
            <div class="custom-card-content">
                <h5 class="mb-0">Lassagne </h5>
            </div>
        ...
        <div class="custom-card mt-1">
            ...
            <!-- Billede -->
            <img src="pictures/hakkebæf.png" alt="Hakkebøf">

            <!-- Tekstindhold -->
            <div class="custom-card-content">
                <h5 class="mb-0">Hakkebøf med Løg og brun sovs </h5>
            </div>
        ...
        <div class="custom-card mt-1">
            ...
            <!-- Billede -->
            <img src="pictures/fishandchips.png" alt="Fish and Chips">

            <!-- Tekstindhold -->
            <div class="custom-card-content">
                <h5 class="mb-0">Fish n Chips med tartarsauce </h5>
            </div>
